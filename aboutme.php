...
<body>
	...
	<ul >
			...
			<div id="main">
				<!--div id="main2"></div-->
				<h2> Ms Bhumika P</h2>
				    <!--img id="image2" src="img/pkn.JPEG" align="left"-->

			    <p> I have done B.E in ISE from Jyothy Institute of Technology in Banglore.I am a web developer with a year
of self-project experiences.Im pursuing my 3rd year BE and interested in web development. The skills i have are C,C++,java,python,javaScript and yet to enhance my skills.
